...
export default function VibeQuizContent() {
  ...
  const handleSelect = useCallback(
    (optionIndex) => {
      ...
      track.questionAnswered(currentQ + 1, `vibe_${question.id}`, selected?.label || String(optionIndex));
