...
export const QUIZ = [
  {
    q: "Pure white vs warm cream.",
    sub: "Which one feels more alive against your skin?",
    options: [
      { label: "Pure white",             key: "cool",    swatch: "#FAFAFA" },
      { label: "Warm cream",             key: "warm",    swatch: "#F8EDD5" },
      { label: "They feel similar",      key: "neutral", swatch: "#F0EDE8" },
  ...
  },
  {
    ...
    options: [
      { label: "Persimmon, olive, cognac",         key: "autumn", swatches: ["#E2725B", "#5E5832", "#8B6F3F"] },
      { label: "Plum noir, true red, icy blue",    key: "winter", swatches: ["#4B1A2F", "#D5102C", "#B8D0E5"] },
      { label: "Butter yellow, peach fuzz, lime",  key: "spring", swatches: ["#F4E5A0", "#F5B9A2", "#A8E02A"] },
      { label: "Cool blue, jade, lavender mist",   key: "summer", swatches: ["#7B9BC2", "#4A8E7D", "#C4B0D4"] },
    ],
  },
  {
    q: "Imagine yourself in a black-and-white photo.",
    sub: "What do you notice about your features?",
    options: [
      { label: "Sharp contrast. My features pop", key: "high-contrast", swatch: "#0F0F0F" },
      { label: "Soft and blended. Low contrast",  key: "low-contrast",  swatch: "#A89B8A" },
      { label: "Even. Balanced, neither extreme", key: "medium",        swatch: "#6B6B6B" },
      { label: "Striking. Dramatic and intense",  key: "dramatic",      swatch: "#1A1A1A" },
    ],
  },
  {
  ...
  {
    q: "A saturated bright color near your face.",
    sub: "Imagine wearing electric magenta or vivid emerald. How does it land?",
    options: [
      { label: "Alive and electric. That's me",        key: "cool-bright", swatch: "#E83F6F" },
      { label: "Beautiful but a touch overwhelming",   key: "cool-soft",   swatch: "#A596B8" },
      { label: "I prefer earthy or richer versions",   key: "warm-deep",   swatch: "#722F37" },
      { label: "Honestly, hard to picture on me",      key: "olive",       swatch: "#C8B89A" },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      { label: "Spring (persimmon, butter yellow, peach fuzz)", key: "spring", swatch: "#E2725B" },
      { label: "Summer (cool blue, jade, lavender mist)",       key: "summer", swatch: "#7B9BC2" },
      { label: "Autumn (persimmon, olive, cognac)",             key: "autumn", swatch: "#8B6F3F" },
      { label: "Winter (plum noir, true red, icy blue)",        key: "winter", swatch: "#4B1A2F" },
    ],
  },
];
