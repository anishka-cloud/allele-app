...
export const QUIZ = [
  {
    q: "Pure white, near your face.",
    sub: "Press a white t-shirt against your jaw. Your skin reads as:",
    options: [
      { label: "Fresh and clean — the white flatters",   key: "cool",    swatch: "#EAF0F2" },
      { label: "Sallow or yellow-tired",                 key: "warm",    swatch: "#E8D9A8" },
      { label: "Pink and flushed, crisp against it",     key: "cool",    swatch: "#F3D8D2" },
      { label: "Ghostly or grey — it washes me out",     key: "olive",   swatch: "#BFBCAF" },
    ],
  },
  {
  ...
  {
    q: "Four palettes, held to your face.",
    sub: "Which one makes your skin look alive — not your face look pale, not your eyes go flat?",
    options: [
  ...
  },
  {
    ...
    sub: "Look at your face — not the shirt. What do you see?",
    options: [
      { label: "Crisp — my features come forward",          key: "high-contrast", swatch: "#0F0F0F" },
      { label: "Heavy — black drags my face down",          key: "low-contrast",  swatch: "#A89B8A" },
      { label: "Even — I look like myself, nothing new",    key: "medium",        swatch: "#6B6B6B" },
      { label: "Theatrical — strong, but a little severe",  key: "dramatic",      swatch: "#1A1A1A" },
    ],
  },
  {
  ...
  {
    q: "Two whites, side by side.",
    sub: "Imagine a cream paper next to a printer-paper white. Which feels more like \"your\" white — the one that looks clean, not yellow or harsh, against your skin?",
    options: [
      { label: "Cream looks clean. Optic white feels stark on me.",          key: "warm",    swatch: "#F4EBD8" },
      { label: "Optic white looks clean. Cream looks dingy on me.",          key: "cool",    swatch: "#FFFFFF" },
      { label: "Honestly, both look fine — I can't tell a difference.",      key: "neutral", swatches: ["#F4EBD8", "#FFFFFF"] },
      { label: "Both look slightly off — I prefer off-whites with a tint.",  key: "soft",    swatches: ["#F0EAE0", "#EDEEF0"] },
    ],
  },
  {
  ...
  },
  {
    ...
    sub: "Four variants. Which makes your teeth look whiter, not yellower?",
    options: [
