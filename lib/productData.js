...
const TIER_META = {
  budget:  { label: "Budget Pick", emoji: "💰", range: "$5–15" },
  value:   { label: "Best Value",  emoji: "✨", range: "$15–30", popular: true },
  splurge: { label: "Splurge",     emoji: "👑", range: "$30–60+" },
};
...
"True Autumn": {
  ...
  lips: {
    ...
    [V]: [{ brand:"Charlotte Tilbury", product:"Matte Revolution Lipstick", shade:"Walk of No Shame", price:"$38", hex:"#9C3A2D" }],
    [S]: [{ brand:"Pat McGrath", product:"MatteTrance Lipstick", shade:"McMenamy", price:"$40", hex:"#8B3A2A" }],
  },
  lipLiner: {
...
"Dark Autumn": {
  ...
  lips: {
    [B]: [{ brand:"NYX", product:"Soft Matte Lip Cream", shade:"Copenhagen", price:"$8", hex:"#800020" }],
    [V]: [{ brand:"MAC", product:"Matte Lipstick", shade:"Diva", price:"$24", hex:"#7A1A24" }],
    [S]: [{ brand:"Charlotte Tilbury", product:"Matte Revolution Lipstick", shade:"Legendary Queen", price:"$38", hex:"#722F37" }],
  },
  lipLiner: {
...
"Dark Winter": {
  ...
  lips: {
    [B]: [{ brand:"NYX", product:"Soft Matte Lip Cream", shade:"Transylvania", price:"$8", hex:"#6B1A3A" }],
    [V]: [{ brand:"MAC", product:"Matte Lipstick", shade:"Sin", price:"$24", hex:"#6B1A2A" }],
    [S]: [{ brand:"YSL", product:"Rouge Pur Couture", shade:"1966", price:"$45", hex:"#8B001F" }],
  },
  lipLiner: {
...
"True Winter": {
  ...
  lips: {
    [B]: [{ brand:"NYX", product:"Soft Matte Lip Cream", shade:"Monte Carlo", price:"$8", hex:"#B8002A" }],
    [V]: [{ brand:"Charlotte Tilbury", product:"Matte Revolution Lipstick", shade:"Red Carpet Red", price:"$38", hex:"#B8252C" }],
...
"Bright Winter": {
  ...
  lips: {
    [B]: [{ brand:"NYX", product:"Soft Matte Lip Cream", shade:"Addis Ababa", price:"$8", hex:"#D4001C" }],
    [V]: [{ brand:"Fenty Beauty", product:"Stunna Lip Paint", shade:"Uncensored", price:"$27", hex:"#D4001C" }],
    [S]: [{ brand:"Charlotte Tilbury", product:"Matte Revolution Lipstick", shade:"Lost Cherry", price:"$38", hex:"#B0182A" }],
  },
  lipLiner: {
