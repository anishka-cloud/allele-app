...
// imported by any render path. The live render path reads productData.js
// (the canonical source) via lib/handoffSeasons.js (productsFor ->
// adaptProducts), which ResultsContent renders in the grid.
