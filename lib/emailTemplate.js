...
export function generateWelcomeEmail(seasonName, kvProducts = null) {
  ...
  // Neutrals — what you actually wear most days (null-safe)
  const neutralsHtml = (seasonData.neutrals || [])
    .map((n) => `<div style="display:inline-block;margin:0 10px 14px;text-align:center;vertical-align:top;width:90px;"><div style="width:44px;height:44px;border-radius:50%;background:${n.hex};margin:0 auto 8px;box-shadow:0 2px 6px ${n.hex}50;border:2px solid rgba(255,255,255,0.5);"></div><div style="font-family:'Inter',Helvetica,sans-serif;font-size:11px;color:#1a1a1a;font-weight:500;margin-bottom:2px;">${n.name}</div><div style="font-family:'Playfair Display',Georgia,serif;font-size:11px;font-style:italic;color:#888;line-height:1.3;">${n.wear}</div></div>`)
    .join("");
...
${neutralsHtml ? `<hr style="border:none;border-top:1px solid #eee;margin:24px 0;">

<h2 style="font-family:'Playfair Display',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 6px;">Your everyday neutrals</h2>
<p style="font-family:'Inter',Helvetica,sans-serif;font-size:13px;color:#888;margin:0 0 14px;">The neutrals that work with your coloring. These are what you actually wear most days.</p>
<div style="text-align:center;margin:8px 0 4px;">${neutralsHtml}</div>` : ""}
