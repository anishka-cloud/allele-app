...
export function generateWelcomeEmail(seasonName, kvProducts = null) {
  ...
  for (const group of sectionGroups) {
    productHtml += `<h3 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:18px;margin:28px 0 12px;color:#1a1a1a;">${group.heading}</h3>\n`;
...
<p style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:24px;font-weight:700;color:#1a1a1a;margin:16px 0 8px;">You're a <span style="color:${seasonData.bestColors[0]};font-style:italic;">${seasonName}</span> ✨</p>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 12px;">Your palette</h2>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 6px;">The 2026 Edit</h2>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 8px;">Celebrity style twins</h2>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 8px;">Your 50+ matches</h2>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 8px;">Colors to avoid</h2>
<p style="font-family:'Inter',Helvetica,sans-serif;font-size:13px;color:#444;line-height:2;">${avoidHtml}</p>

<hr style="border:none;border-top:1px solid #eee;margin:24px 0;">

<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 12px;">Pro tips for ${seasonName}s</h2>
<ol style="padding-left:20px;margin:0;">${tipsHtml}</ol>

<hr style="border:none;border-top:1px solid #eee;margin:24px 0;">

<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 8px;">Share your shade</h2>
...
<h2 style="font-family:'Lora','GT Sectra',Georgia,serif;font-size:20px;color:#1a1a1a;margin:0 0 8px;">What's next from Allele</h2>
