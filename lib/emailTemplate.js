...
const SEASON_META = {
  "Clear Spring": {
    ...
    celebs: "Mila Kunis, Gigi Hadid, Selena Gomez",
    palette: "Coral · Peach · Warm Ivory · Golden Honey · Bright Turquoise · Clear Navy · Light Camel · Warm Red · Golden Yellow · Apricot · Fresh Green · Soft White",
    tips: [
  ...
  "True Spring": {
    ...
    celebs: "Blake Lively, Nicole Kidman, Reese Witherspoon",
    palette: "Tomato red · Coral · Golden yellow · Warm peach · Bright grass green · Turquoise · Warm ivory · Camel · Tangerine · Poppy · Apple green · Cream",
    tips: [
  ...
  "Light Spring": {
    ...
    celebs: "Taylor Swift, Kristen Bell, Amanda Seyfried",
    palette: "Peach · Soft coral · Warm ivory · Butter yellow · Light aqua · Camel · Periwinkle · Pale warm pink · Mint · Apricot · Sand · Champagne",
    tips: [
  ...
  "Light Summer": {
    ...
    celebs: "Cate Blanchett, Michelle Pfeiffer, Gwyneth Paltrow",
    palette: "Powder blue · Soft lavender · Dusty rose · Light periwinkle · Pale grey · Icy pink · Soft aqua · Platinum · Dove · Cool mauve · Sky blue · Silver",
    tips: [
  ...
  "True Summer": {
    ...
    celebs: "Jackie Kennedy, Kate Middleton, Emily Blunt",
    palette: "Mauve · Soft raspberry · Dusty pink · Cool lilac · Blue-grey · Rose · Periwinkle · Muted teal · Lavender · Steel blue · Plum pink · Soft navy",
    tips: [
  ...
  "Soft Summer": {
    ...
    celebs: "Keira Knightley, Jennifer Aniston, Sarah Jessica Parker",
    palette: "Grayed rose · Taupe · Soft plum · Cool greige · Dusty blue · Muted mauve · Sage · Cool cocoa · Lavender grey · Dusty teal · Rose beige · Ash",
    tips: [
  ...
  "Soft Autumn": {
    ...
    celebs: "Jennifer Lopez, Scarlett Johansson, Drew Barrymore",
    palette: "Terracotta · Dusty peach · Warm brown · Muted olive · Warm clay · Soft camel · Rust · Sage green · Warm taupe · Mushroom · Burnt sienna · Khaki",
    tips: [
  ...
  "True Autumn": {
    ...
    celebs: "Julia Roberts, Jessica Chastain, Isla Fisher",
    palette: "Pumpkin · Brick · Warm brown · Olive · Rust · Terracotta · Forest green · Warm gold · Cinnamon · Toffee · Burnt orange · Deep teal",
    tips: [
  ...
  "Dark Autumn": {
    ...
    celebs: "Kim Kardashian, Eva Mendes, Penélope Cruz",
    palette: "Chocolate · Deep burgundy · Rich terracotta · Forest green · Dark gold · Olive · Oxblood · Burnt umber · Bronze · Dark teal · Espresso · Warm charcoal",
    tips: [
  ...
  "Dark Winter": {
    ...
    celebs: "Megan Fox, Anne Hathaway, Lucy Liu",
    palette: "Deep navy · Plum · Charcoal · Deep wine · Black · Emerald · Deep burgundy · Icy pink · Royal purple · Dark teal · True red · Bright white",
    tips: [
  ...
  "True Winter": {
    ...
    celebs: "Lupita Nyong'o, Courteney Cox, Meghan Markle",
    palette: "Pure red · Hot pink · Black · Icy white · Royal blue · Emerald · Fuchsia · Cobalt · True red · Silver · Pure white · Deep navy",
    tips: [
  ...
  "Bright Winter": {
    ...
    celebs: "Liv Tyler, Demi Moore, Katy Perry",
    palette: "Fuchsia · Electric blue · Bright berry · Icy pink · Vivid purple · Cobalt · Hot pink · Bright teal · Magenta · Lime · Black · White",
    tips: [
