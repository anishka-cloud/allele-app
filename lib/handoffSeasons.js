...
export const SEASONS = {
  ...
  'light-spring': {
    ...
    celebs: [
      ...
      { name: "IU (Lee Ji-eun)", contested: false, note: null, signatureColor: '#C6E2B5' },
    ],
  },
  'light-summer': {
    name: 'Light Summer',
  ...
  'soft-summer': {
    ...
    surface: '#F8F5FB',
    celebs: [
      { name: "Leona Lewis", contested: false, note: null, signatureColor: '#8C9B8A' },
