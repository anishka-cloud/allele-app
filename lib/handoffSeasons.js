...
export const SEASONS = {
  'clear-spring': {
    ...
    depth: 'Medium',
    chroma: 'Bright / Clear',
    whisper: 'Coral, peach, and sun-warmed yellow. Your coloring runs vivid and unmistakable.',
    ...
    surface: '#FFFBF7',
    celebs: [
      { name: "Emma Stone", contested: false, note: null },
      { name: "Emmy Rossum", contested: false, note: null },
      { name: "Kerry Washington", contested: false, note: null },
  ...
  'true-spring': {
    ...
    depth: 'Medium',
    chroma: 'Bright',
    whisper: 'Honey, apricot, and fresh leaf. Gold is your neutral.',
    ...
    surface: '#FFFBF3',
    celebs: [
      { name: "Amy Adams", contested: false, note: null },
      { name: "Isla Fisher", contested: false, note: null },
      { name: "Nicole Scherzinger", contested: false, note: null },
  ...
  'light-spring': {
    ...
    depth: 'Light',
    chroma: 'Soft-Bright',
    whisper: 'Blush, buttercream, warm ivory. A pale warm watercolour.',
    ...
    surface: '#FFFEF5',
    celebs: [
      { name: "Taylor Swift", contested: false, note: null },
      { name: "Margot Robbie", contested: false, note: null },
      { name: "Saoirse Ronan", contested: false, note: null },
  ...
  'light-summer': {
    ...
    depth: 'Light',
    chroma: 'Soft-Muted',
    whisper: 'Dusty rose, periwinkle, a pale cool morning.',
    ...
    surface: '#FAFAFA',
    celebs: [
      { name: "Elle Fanning", contested: false, note: null },
      { name: "Cate Blanchett", contested: false, note: null },
      { name: "Gemma Chan", contested: false, note: null },
  ...
  'true-summer': {
    ...
    depth: 'Medium',
    chroma: 'Muted',
    whisper: 'Mauve, raspberry, a quiet ocean at dusk.',
    ...
    surface: '#F5F8FC',
    celebs: [
      { name: "Emily Blunt", contested: false, note: null },
      { name: "Sarah Jessica Parker", contested: false, note: null },
      { name: "Zoe Saldana", contested: false, note: null },
  ...
  'soft-summer': {
    ...
    depth: 'Medium',
    chroma: 'Very Muted',
    whisper: 'Grayed plum, fog, taupe rose. Everything whispers.',
    ...
    surface: '#F8F5FB',
    celebs: [
      { name: "Cara Delevingne", contested: false, note: null },
      { name: "Jennifer Aniston", contested: false, note: null },
      { name: "Kate Middleton", contested: false, note: null },
  ...
  'soft-autumn': {
    ...
    depth: 'Medium',
    chroma: 'Muted',
    whisper: 'Dried herbs, terracotta, honey on linen.',
    ...
    surface: '#FBF8F5',
    celebs: [
      { name: "Gigi Hadid", contested: false, note: null },
      { name: "Jennifer Lopez", contested: false, note: null },
      { name: "Jessica Biel", contested: false, note: null },
  ...
  'true-autumn': {
    ...
    depth: 'Medium-Deep',
    chroma: 'Muted',
    whisper: 'Burnt orange, rust, forest, deep gold. The cathedral in October.',
    ...
    surface: '#FBF6F0',
    celebs: [
      { name: "Julia Roberts", contested: false, note: null },
      { name: "Beyoncé", contested: false, note: null },
      { name: "Eva Mendes", contested: false, note: null },
  ...
  'dark-autumn': {
    ...
    depth: 'Deep',
    chroma: 'Muted',
    whisper: 'Chocolate, garnet, forest floor after rain.',
    ...
    surface: '#F5EDE5',
    celebs: [
      { name: "Keira Knightley", contested: false, note: null },
      { name: "Penélope Cruz", contested: false, note: null },
      { name: "Mindy Kaling", contested: false, note: null },
  ...
  'dark-winter': {
    ...
    depth: 'Deep',
    chroma: 'Muted',
    whisper: 'Midnight, plum, charcoal, deep wine.',
    ...
    surfaceText: '#F5EEDC',
    celebs: [
      { name: "Lily Collins", contested: false, note: null },
      { name: "Lucy Liu", contested: false, note: null },
      { name: "Viola Davis", contested: false, note: null },
  ...
  'true-winter': {
    ...
    depth: 'Deep',
    chroma: 'Bright / Clear',
    whisper: 'True red, icy blue, pure black, pure white.',
    ...
    surface: '#FFFBF7',
    celebs: [
      { name: "Anne Hathaway", contested: false, note: null },
      { name: "Fan Bingbing", contested: false, note: null },
      { name: "Lupita Nyong'o", contested: false, note: null },
  ...
  'bright-winter': {
    ...
    depth: 'Medium-Deep',
    chroma: 'Vivid',
    whisper: 'Fuchsia, electric blue, bright berry. Full saturation.',
    ...
    surface: '#F8F5FF',
    celebs: [
      { name: "Megan Fox", contested: false, note: null },
      { name: "Dita Von Teese", contested: false, note: null },
      { name: "Naomi Campbell", contested: false, note: null },
